...
"")
        ...
        icon = QIcon()
        icon.addFile(u":/icon/assets/icons/black/icon-excel.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btn_icon_logo.setIcon(icon)
        ...
        self.horizontalLayout_11.setContentsMargins(-1, 9, -1, 0)
        ...
        self.file_xls_footer.setMinimumSize(QSize(0, 50))
        self.file_xls_footer.setMaximumSize(QSize(16777215, 50))
...
"")
        icon1 = QIcon()
        icon1.addFile(u":/icon/assets/icons/white/upload_file_white.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
...
"")
        ...
        self.content_right.setMaximumSize(QSize(16777215, 16777215))
        ...
        icon2 = QIcon()
        icon2.addFile(u":/icon/assets/icons/white/search-white.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
